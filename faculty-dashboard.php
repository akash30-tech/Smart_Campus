...
<head>
    ...
    <title>Faculty Dashboard - Smart Campus Management System</title>
...
<body>
    ...
    <div class="content-container">
        <div class="content-header">
            ...
            <p>Manage your courses, view attendance, and more.</p>
        </div>

        <div class="card-container">
            <div class="card">
                <h3>Manage Courses</h3>
                <p>View and manage the courses assigned to you.</p>
            ...
            <div class="card">
                <h3>Make Examinations</h3>
                <p>Schedule and manage exams and results.</p>
